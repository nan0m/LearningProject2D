...
var enemy_type = ManagerGame.enemy_data['cruiser']['class']
var move_speed = ManagerGame.enemy_data['cruiser']['speed']
var hp = ManagerGame.enemy_data['cruiser']['hp']   #enemy hitpoints, obviously
var edamage = ManagerGame.enemy_data['cruiser']['attack']  #enemy damage
var rof = ManagerGame.enemy_data['cruiser']['rof']   #enemy rate of fire
var rng = ManagerGame.enemy_data['cruiser']['range'] #enemy range
var notu = ManagerGame.enemy_data['cruiser']['not']  #number of turret
