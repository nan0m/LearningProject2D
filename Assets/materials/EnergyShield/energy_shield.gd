...
func add_impact(global_pos: Vector3, total_lifetime: float):
	var im := Impact.new()
	im.location = global_pos
...
#	add_impact(Vector3(10,10,0.0),100.0)
#	add_impact(Vector3(100,100,0.0),10.0)
#	add_impact(Vector3(800,800,0.0),20.0)
#	add_impact(Vector3(600,1230,0.0),20.0)
...
func _pack_position_to_color(global_pos: Vector3) -> Color:
	var col := Color()
